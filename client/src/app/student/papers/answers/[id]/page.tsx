        ...
        <div className="space-y-8">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-6 flex flex-wrap items-center justify-between gap-6">
              {studentAttempt.paperId?.paperType === 'MCQ' && (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
                    {studentAttempt.paperId?.paperType === 'Structure-Essay' ? 'Your Score' : 'Percentage'}
                  </p>
            ...
            {studentAttempt.paperId?.paperType === 'Structure-Essay' && (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-6 space-y-4 mt-8"
              >
