...
export default function CreatePaperPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50" ref={topRef}>
      <Navbar user={user} />
        ...
        >
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900">Create New Paper</h1>
                <p className="text-gray-600 text-lg">Design and build your examination paper with detailed explanations</p>
              </div>
            </div>
            <Link href="/papers">
          ...
          {/* Paper Details Form */}
          <motion.div 
            className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8 mb-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <label className="font-semibold text-gray-700 mb-3 block text-lg">Paper Title</label>
                <Input
              ...
              {/* Description */}
              <div className="md:col-span-2">
                <label className="font-semibold text-gray-700 mb-3 block text-lg">Description (Optional)</label>
                <Textarea
                  placeholder="A brief summary of the paper's content and topics covered..."
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  className="min-h-[100px] text-lg border-2 focus:border-blue-500 rounded-xl"
                />
              </div>
              {/* Deadline */}
              <div>
                <label className="font-semibold text-gray-700 mb-3 flex items-center gap-2 text-lg">
                  <Calendar size={20} className="text-blue-600" /> Deadline
                </label>
                <Input
                  type="datetime-local"
                  value={deadline}
              ...
              <div>
                <label className="font-semibold text-gray-700 mb-3 flex items-center gap-2 text-lg">
                  <Clock size={20} className="text-blue-600" /> Time Limit (minutes)
                </label>
                <Input
                  type="number"
                  value={timeLimit}
          ...
          {/* Questions Builder */}
          <motion.div 
            className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-3">
                ...
                Questions Builder
                <span className="text-lg font-normal text-gray-500">({questions.length} questions)</span>
              </h2>
            ...
            {questions.length === 0 ? (
              ...
              >
                <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
                  <ListOrdered size={32} className="text-gray-400" />
                </div>
                <h3 className="text-xl font-semibold text-gray-600 mb-2">No questions added yet</h3>
                <p className="text-gray-500 mb-6">Click "Add Question" to start building your paper with detailed explanations</p>
              ...
              <div className="space-y-6">
                <AnimatePresence>
                  {questions.map((q, qIndex) => (
                    ...
                    >
                      <div 
                        className="bg-gradient-to-r from-gray-50 to-blue-50 p-6 flex items-center justify-between cursor-pointer hover:from-gray-100 hover:to-blue-100 transition-colors"
                      ...
                      <AnimatePresence>
                        {q.open && (
                          ...
                          >
                            {/* Question Text */}
                            <div>
                              <label className="font-semibold text-gray-700 mb-3 block text-lg">Question Text</label>
                              <Textarea
                                placeholder={`Enter the question text for question ${qIndex + 1}...`}
                                value={q.questionText}
                                onChange={(e) => handleQuestionChange(qIndex, e.target.value)}
                                className="text-lg min-h-[120px] border-2 focus:border-blue-500 rounded-xl"
                              />
                            </div>

                            {/* Question Image Upload */}
                            <div>
                              <label className="font-semibold text-gray-700 mb-3 block text-lg flex items-center gap-2">
                              ...
                              <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-blue-400 transition-colors">
                                {q.imageUrl ? (
                                  ...
                                  <div className="text-center">
                                    ...
                                    />
                                    <p className="text-sm text-gray-500 mt-2">Upload an image to accompany this question</p>
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            <div>
                              <div className="flex items-center justify-between mb-4">
                                <label className="font-semibold text-gray-700 text-lg">Answer Options</label>
                                <Button
                              ...
                              <div className="space-y-4">
                                {q.options.map((opt, oIndex) => (
                                  <motion.div 
                                    key={oIndex}
                                    className="flex items-center gap-4 p-4 border-2 rounded-xl hover:border-blue-300 transition-colors"
                                  ...
                                  >
                                    ...
                                    <div className="flex-1">
                                      <Input
                                        ...
                                        className="text-lg h-12 border-2 focus:border-blue-500 rounded-lg"
                                      />
                                    </div>
                                    {q.options.length > 2 && (
                                      <Button
                            ...
                            <div className="border-t-2 border-gray-100 pt-8">
                              <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                  <h3 className="font-semibold text-gray-700 text-lg">Detailed Explanation (විවරණ)</h3>
                                  <p className="text-sm text-gray-500">Optional: Help students understand how to get the correct answer</p>
                                </div>
                              </div>
                              
                              {/* Explanation Text */}
                              <div className="mb-6">
                                <label className="font-medium text-gray-600 mb-2 block">Explanation Text</label>
                                <Textarea
                                  ...
                                  className="min-h-[100px] border-2 focus:border-amber-500 rounded-xl"
                                />
                              </div>

                              {/* Explanation Image */}
                              <div>
                                <label className="font-medium text-gray-600 mb-2 block flex items-center gap-2">
                                  <ImageIcon size={16} className="text-amber-600" />
                                  Explanation Image (Optional)
                                </label>
                                <div className="border-2 border-dashed border-amber-300 rounded-xl p-4 hover:border-amber-400 transition-colors bg-amber-50/30">
                                  {q.explanation?.imageUrl ? (
                                    ...
                                    <div className="text-center">
                                      ...
                                      />
                                      <p className="text-xs text-gray-500 mt-1">Upload diagrams, charts, or visual aids</p>
                                    </div>
                                  )}
                                </div>
                              </div>
          ...
          <AnimatePresence>
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="mt-6 bg-red-50 border-l-4 border-red-500 p-6 rounded-xl shadow-md"
              >
                <div className="flex items-center gap-3">
