            ...
            <div className="border-t border-[var(--theme-border)] pt-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[var(--theme-text-primary)]">{formData.year}</h4>
                    <p className="text-sm text-[var(--theme-text-secondary)]">Academic Year: {formData.year}</p>
                  </div>
                </div>
              </div>
            </div>
