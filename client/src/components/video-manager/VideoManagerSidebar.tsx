...
interface VideoManagerSidebarProps {
    user?: {
        firstName?: string;
        lastName?: string;
        username?: string;
...
const menuItems = [
    {
        ...
        href: "/video-manager/dashboard",
        colorClass: "sidebar-icon-dashboard",
    },
    {
        title: "Videos",
        icon: Video,
        href: "/video-manager/videos",
        colorClass: "sidebar-icon-videos",
    },
];

export function VideoManagerSidebar({ user, onLogout }: VideoManagerSidebarProps) {
                    ...
                    <>
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs theme-text-secondary truncate">Video Manager</p>
                            </div>
                        </div>
                        <SidebarToggle
