...
exports.getPaymentStatus = exports.handleNotify = exports.initiatePayment = void 0;
...
const handleNotify = async (req, res) => {
    try {
        ...
        if (localHash !== md5sig) {
            console.error(`❌ PayHere Webhook: Signature verification failed. Received: ${md5sig}, Calculated: ${localHash}`);
