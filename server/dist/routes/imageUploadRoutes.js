...
router.post('/upload/paper-options', (req, res, next) => {
    req.uploadType = 'option'; // Maps to uploads/paper/answers
    next();
...
router.post('/upload/question', (req, res, next) => {
    req.uploadType = 'question'; // Maps to uploads/paper/questions
    next();
...
router.post('/upload/explanation', (req, res, next) => {
    req.uploadType = 'explanation'; // Maps to uploads/paper/explanations
    next();
