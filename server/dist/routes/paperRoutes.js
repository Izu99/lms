...
router.post('/attempts/:attemptId/upload-review', auth_1.protect, multer_1.upload.single('file'), paperController_1.uploadTeacherReviewFile); // New route for uploading teacher review files
...
router.put('/:id', auth_1.protect, multer_1.upload.fields([{ name: 'file', maxCount: 1 }, { name: 'previewImage', maxCount: 1 }]), paperController_1.updatePaper);
