...
router.post('/', auth_1.protect, auth_1.requireVideoAccess, videoUpload_1.uploadVideo.fields([{ name: 'video', maxCount: 1 }, { name: 'thumbnail', maxCount: 1 }]), videoController.uploadVideo);
router.get('/', auth_1.protect, videoController.getAllVideos);
router.get('/:id', auth_1.protect, videoController.getVideoById);
router.put('/:id', auth_1.protect, auth_1.requireVideoAccess, videoUpload_1.uploadVideo.fields([{ name: 'video', maxCount: 1 }, { name: 'thumbnail', maxCount: 1 }]), videoController.updateVideo);
router.delete('/:id', auth_1.protect, auth_1.requireVideoAccess, videoController.deleteVideo);
