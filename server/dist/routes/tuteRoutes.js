...
// Teacher routes
router.post('/', auth_1.protect, tuteUpload_1.uploadTute.fields([{ name: 'file', maxCount: 1 }, { name: 'previewImage', maxCount: 1 }]), tuteController_1.createTute);
...
router.put('/:id', auth_1.protect, tuteUpload_1.uploadTute.fields([{ name: 'file', maxCount: 1 }, { name: 'previewImage', maxCount: 1 }]), tuteController_1.updateTute);
