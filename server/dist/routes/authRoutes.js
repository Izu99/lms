...
]), authController_1.register); // Client must send 'uploadType: 'id-card' in the form data
...
router.put('/users/:id', auth_1.protect, multer_1.upload.fields([
    { name: 'idCardFront', maxCount: 1 },
    { name: 'idCardBack', maxCount: 1 }
]), authController_1.updateUserProfile); // Client must send 'uploadType: 'id-card' in the form data
